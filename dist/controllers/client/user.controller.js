...
const generate_hepler_1 = require("../../helpers/generate.hepler");
...
const register = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const token = (0, generate_hepler_1.generateRandomString)(30);
        ...
        const user = new user_model_1.default(userDataRegister);
        yield user.save();
        res.json({
            code: 200,
